namespace Kraken.WebSockets.Messages
{
    ...
    public static class Pair
    {
        ...
        /// Cardano / Ether
        /// </summary>
        public const string ADA_ETH = "ADA/ETH";

        /// <summary>
        /// Cardano / Euro
        /// </summary>
        public const string ADA_EUR = "ADA/EUR";
        ...
        /// <summary>
        /// Cardano / Canadian Dollar
        /// </summary>
        public const string ADA_CAD = "ADA/CAD";

        /// <summary>
        /// Cardano / Bitcoin
        /// </summary>
        public const string ADA_XBT = "ADA/XBT";

        /// <summary>
        /// Cosmos / Canadian Dollar
        /// </summary>
        public const string ATOM_CAD = "ATOM/CA";

        /// <summary>
        /// Cosmos / Ether
        /// </summary>
        public const string ATOM_ETH = "ATOM/ET";

        /// <summary>
        /// Cosmos / Euro
        /// </summary>
        public const string ATOM_EUR = "ATOM/EU";

        /// <summary>
        /// Cosmos / US Dollar
        /// </summary>
        public const string ATOM_USD = "ATOM/US";

        /// <summary>
        /// Cosmos / Bitcoin
        /// </summary>
        public const string ATOM_XBT = "ATOM/XB";

        /// <summary>
        /// Bitcoin Cash / Euro
        /// </summary>
        public const string BCH_EUR = "BCH/EUR";

        /// <summary>
        /// Bitcoin Cash / US Dollar
        /// </summary>
        public const string BCH_USD = "BCH/USD";

        /// <summary>
        /// Bitcoin Cash / Bitcoin
        /// </summary>
        public const string BCH_XBT = "BCH/XBT";
